...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var n = x7.name$2;
      var assertion = (!this.visited$1.contains__O__Z(n));
      if ((!assertion)) {
        throw new $c_jl_AssertionError().init___O(("assertion failed: " + "cyclic variable definition"))
      };
      this.visited$1 = $as_sci_Set(this.visited$1.$$plus__O__sc_Set(n));
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      ...
      switch (x1) {
        default:
          return (((x1 >= 0) && (x1 < 15)) ? "orange" : ((x1 < 0) ? "red" : "green"));
      }
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
...
$c_Lcalculator_CalculatorUI$.prototype.setupCalculator__V = (function() {
  ...
  var this$15 = names.iterator__sci_VectorIterator();
...
$c_Lcalculator_Calculator$$anonfun$computeValues$2.prototype.apply__T2__T2 = (function(x$1) {
  if ((x$1 !== null)) {
    ...
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, k$1, v$1) {
      return (function() {
        $m_Lcalculator_Calculator$().visited$1 = $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()));
        $m_Lcalculator_Calculator$().visited$1 = $as_sci_Set($m_Lcalculator_Calculator$().visited$1.$$plus__O__sc_Set(k$1));
